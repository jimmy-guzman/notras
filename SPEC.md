...
- The tab context menu offers close, close others, close to the right, and copy path, acting on the tab it opened over. The last three are also palette actions acting on the tab that is showing, and ⌘⌥W closes the others.
