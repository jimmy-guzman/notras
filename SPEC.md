...
- A bare title counts when it stands as a whole word, without regard to case, outside links, code, HTML, and the other note's own title heading. The filename is not searched, and two notes sharing a title both count the same bare line.
