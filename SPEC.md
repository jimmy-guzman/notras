...
| Effect-TS     | Effect 4: `Context.Service` + `static layer`, ManagedRuntime, `Schema.TaggedError`                                              |
...
note_fts(path UNINDEXED, title, content)  -- fts5, unicode61; bm25 + snippet() as today
```
