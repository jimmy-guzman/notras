...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent
      ...
      alignOffset={alignOffset}
      className={cn(
        "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:fade-in-0 data-open:zoom-in-95 data-closed:fade-out-0 data-closed:zoom-out-95 bg-popover text-popover-foreground ring-foreground/5 data-closed:animate-out data-open:animate-in w-auto min-w-36 rounded-2xl p-1 shadow-2xl ring-1 duration-100",
        className
      )}
