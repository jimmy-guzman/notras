...
- The PDF is set in the light palette on white paper, in system sans at 12pt and system monospace at 10.5pt, and carries the note's title as its document title. Code blocks keep their highlighting on a muted background and long code lines wrap. Inline code retains its near-white background. Task boxes, inline code, links and their underlines, wikilink pills and tables print as they show on screen. An image prints at its on-screen size; a missing one prints as the broken image the editor shows.
