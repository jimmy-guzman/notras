...
| `format-service` (reimplemented on remark, since oxfmt is napi and cannot run in the webview) | drizzle-kit, `@libsql/client`, sharp, fflate usage        |
