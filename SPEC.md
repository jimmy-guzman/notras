...
- Rich mode on a note of any length takes each keystroke without lag: only the block under the edit is re-serialized, and the title comes from the first blocks that settle it.
