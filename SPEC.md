...
- Find mode offers visible folder and tag choices. Incomplete tokens show suggestions. Folder suggestions include ancestors and subtree counts, with a "notes root" choice. Picking a suggestion replaces the unfinished token and preserves other filters and free text. Values accept quotes and escaped quotes or backslashes.
