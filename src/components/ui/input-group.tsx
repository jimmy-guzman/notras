...
function InputGroup({
  ...
  return (
    <div
      ...
      // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- a fieldset carries form-section semantics and chrome the group does not want
      role="group"
      className={cn(
        ...
        "data-[variant=sidebar]:bg-background data-[variant=sidebar]:rounded-md data-[variant=sidebar]:pointer-coarse:h-11 data-[variant=sidebar]:[&_input]:text-xs",
        className
      )}
      {...props}
    />
...
function InputGroupAddon({
  ...
  return (
    // oxlint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-noninteractive-element-interactions -- a pointer convenience; keyboard users tab into the input
    <div
      // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- a fieldset carries form-section semantics and chrome the addon does not want
      role="group"
...
function InputGroupText({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      className={cn(
        "text-muted-foreground flex items-center gap-2 text-sm tabular-nums [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
